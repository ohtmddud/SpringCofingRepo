...
<body>
	<form class="form-horizontal" action="/erp/board/read.do?state=UPDATE&board_no=${board.board_no }" method="post" >
		...
		<div class="form-group">
			<div class="col-md-10 text-center">
				<input type="submit" class="btn btn-lg btn-primary" value="수정">
					<button type="button" class="btn btn-danger btn-lg"	onclick="location.href='/erp/board/list.do'">
						<i class="fa fa-fw fa-close"></i> 목록
					</button>
					<button type="button" class="btn btn-danger btn-lg"	onclick="location.href='/erp/board/delete?board_no=${board.board_no}'" id="deletebtn">
