...
<body>
	<h4><i class="fa fa-angle-right"></i> 게시글 작성하기</h4>
	<hr>
	<div class="row mt">
		<div class="col-lg-12">
			<div class="form-panel">
			
				<form class="form-horizontal style-form" action="/springmvc/board/write.do" method="post">
					<div class="form-group" style="border: 1px solid #eff2f7;">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="content" style="width: 100%; border: 1; overflow: visible; 
								text-overflow: ellipsis;" rows=15 name="content">글작성</textarea>
