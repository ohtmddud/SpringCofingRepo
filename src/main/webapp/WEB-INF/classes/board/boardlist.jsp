		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="/springmvc/board/read.do?board_no=<%=board.getBoard_no() %>&state=READ"><%=board.getTitle()%></a></td>
					<td><%=board.getId()%></td>
					<td><%=board.getWrite_date()%></td>
					<td><a href="/springmvc/board/delete.do?board_no=<%=board.getBoard_no() %>">삭제</a></td>
				</tr>
				<%
				}
				%>
